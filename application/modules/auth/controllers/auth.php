...
//               $this->template->auth( $view,$this->viewdata,$render);
            $this->load->view('template/components/headerfile');
            $view_html = $this->load->view($view, $this->viewdata, $render);

            $this->load->view('template/components/footerfile');
        } else {
