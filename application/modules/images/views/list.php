...
<link type="text/css" rel="stylesheet" href="<?php echo (site_url('assets/image_crud/css/fineuploader.css')) ?>" />
<link type="text/css" rel="stylesheet" href="<?php echo (site_url('assets/image_crud/css/photogallery.css')) ?>" />
<link type="text/css" rel="stylesheet" href="<?php echo (site_url('assets/image_crud/css/colorbox.css')) ?>" />

<script src="<?php echo site_url('assets/image_crud/js/jquery-1.8.2.min.js') ?>"></script>
<script src="<?php echo site_url('assets/image_crud/js/jquery-ui-1.9.0.custom.min.js') ?>"></script>
<script src="<?php echo site_url('assets/image_crud/js/fineuploader-3.2.min.js') ?>"></script>
<script src="<?php echo site_url('assets/image_crud/js/jquery.colorbox-min.js') ?>"></script>
<script>
$(function(){
	<?php if ( ! $unset_upload) {?>
		createUploader();
