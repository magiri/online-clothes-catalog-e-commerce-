...
<?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <?php echo form_textarea('description', set_value('description', $category->description), 'class= "form-control" id="editorTextAreaBody" rows="150"  style="overflow: hidden; word-wrap: break-word;"') ?>
